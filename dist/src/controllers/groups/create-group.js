...
var groups_1 = __importStar(require("../../models/groups"));
function CreateGroup(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var error, isGroupExist, isUserExist, newGroup, group;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    error = (0, groups_1.validateGroup)(req.body).error;
                    if (error)
                    ...
                    return [4 /*yield*/, groups_1.default.findOne({
                            fullName: req.body.fullName,
                        })];
                case 1:
                    isGroupExist = _a.sent();
                    if (isGroupExist) {
                        return [2 /*return*/, res.status(400).send((0, message_1.default)({
                                statusCode: 400,
