...
function deleteSelfChatGroup(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var validateGroupIdRes, isSenderExist, isReceiver, isChatExist, selfDeletedChat, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, chat_group_1.default.findById(req.params.chatId)];
                case 3:
                    isChatExist = _a.sent();
                    if (!isChatExist) {
                        return [2 /*return*/, res.status(404).send((0, message_1.default)({
                    ...
                    return [4 /*yield*/, chat_group_1.default.findByIdAndUpdate(req.params.chatId, {
                            $set: {
                                isDeletedMe: true,
                            },
                        }, { new: true })];
                case 4:
                    selfDeletedChat = _a.sent();
                    return [4 /*yield*/, (selfDeletedChat === null || selfDeletedChat === void 0 ? void 0 : selfDeletedChat.save())];
                case 5:
                    result = _a.sent();
...
exports.default = deleteSelfChatGroup;
