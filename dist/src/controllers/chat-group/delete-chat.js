...
function deleteChatGroup(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var validateGroupIdRes, isSenderExist, isReceiver, isChatExist, selfDeletedChat;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, chat_group_1.default.findByIdAndRemove(req.params.chatId)];
                case 4:
...
exports.default = deleteChatGroup;
