...
var chat_group_1 = require("../../models/chat-group");
var message_1 = __importDefault(require("../../views/message"));
var user_1 = __importDefault(require("../../models/user"));
var chat_group_2 = __importStar(require("../../models/chat-group"));
var groups_1 = __importDefault(require("../../models/groups"));
function postChatGroup(req, res, next) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var validateGroupIdRes, error, isSenderExist, isReceiver, newChat, chat;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    validateGroupIdRes = (0, chat_group_2.validateGroupId)({
                        groupId: req.params.groupId,
                    });
                    if (validateGroupIdRes.error)
                        return [2 /*return*/, res.status(401).send((0, message_1.default)({
                                statusCode: 400,
                                data: validateGroupIdRes.error.message,
                                message: "Bad Request",
                            }))];
                    error = (0, chat_group_1.validateChatGroup)(req.body).error;
                    if (error)
                ...
                case 2:
                    ...
                    newChat = new chat_group_2.default({
