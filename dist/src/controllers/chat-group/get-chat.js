...
function getChatGroup(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var validateGroupIdRes, error, isSenderExist, isReceiver, allChat;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, chat_group_1.default.find({
                            groupId: req.params.groupId,
