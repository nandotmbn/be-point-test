        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    res
                        .header("x-auth-token", jsonwebtoken_1.default.sign({ _id: isDeviceExist._id }, process.env.jwtPrivateKey))
                        .send((0, message_1.default)({
                        statusCode: 200,
                        message: "You have successfully logged in",
                        data: lodash_1.default.pick(isDeviceExist, ["deviceName", "_id"]),
                    }));
                    return [2 /*return*/];
            }
        });
